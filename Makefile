...
SYNC_DEPS := swim-developer-root swim-fixm-model-ed254 swim-developer-framework swim-developer-extensions
...
help:
	@echo ""
	@echo "  swim-ed254-consumer — available targets"
	@echo "  ─────────────────────────────────────────────────────────"
	@echo ""
	@echo "  Local dev:"
...
deps:
	...
	@echo ""
	@echo "    git clone https://github.com/swim-developer/swim-fixm-model-ed254"
	@echo "    cd swim-fixm-model-ed254 && ./mvnw clean install -DskipTests"
	@echo ""
